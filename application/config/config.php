...
|
*/
$config['base_url'] = 'http://localhost/web/processo_de_aquisicao/';//todo add index.php
...
|
*/
$config['language']	= 'english';//todo translater for brazil
...
*/
$config['composer_autoload'] = FALSE;//todo verificar
