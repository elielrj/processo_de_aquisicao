    ...
    <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo base_url('index.php/arquivos'); ?>">Arquivos</a>
                <a class="collapse-item" href="<?php echo base_url('index.php/artefatos'); ?>">Artefato</a>
                <a class="collapse-item" href="<?php echo base_url('index.php/departamentos'); ?>">Departamento</a>
                <a class="collapse-item" href="<?php echo base_url('index.php/leis'); ?>">Lei</a>
                <a class="collapse-item" href="<?php echo base_url('index.php/modalidades'); ?>">Modalidade</a>
                <a class="collapse-item" href="<?php echo base_url('index.php/processos'); ?>">Processos</a>
                ...
                <a class="collapse-item" href="<?php echo base_url('index.php/usuarios'); ?>">Usuários</a>
            </div>
        </div>
    </li>
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item"
                    href="<?php echo base_url('index.php/UsuarioController/listarAtivos'); ?>">Desativar</a>
                <a class="collapse-item"
                    href="<?php echo base_url('index.php/UsuarioController/listarDesativados'); ?>">Ativar</a>
