...
echo "<h1>{$titulo}</h1>" . "</br>" .
 form_open('DepartamentoController/atualizar', array('class' => 'form-group')) .
 ...
 form_label('Sigla') . form_input(['name' => 'sigla', 'class' => 'form-control', 'maxlength' => 20, 'value' => $departamento->sigla]) . "</br>" .
