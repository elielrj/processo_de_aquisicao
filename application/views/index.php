            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"
                            href="<?php echo base_url('index.php/UsuarioController/novo'); ?>">Novo</a>
                        <a class="collapse-item"
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Novo:</h6>
                        <a class="collapse-item"
                            href="<?php echo base_url('index.php/ProcessoController'); ?>">Todos</a>
                        <a class="collapse-item"
                            href="<?php echo base_url('index.php/ProcessoController/novo'); ?>">Novo</a>
                    </div>
                </div>
            </li>
